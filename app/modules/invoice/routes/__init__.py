...
def register_routes(app, service, config, env):
    ...
    invoice_routes.add_url_rule('/create', view_func=c.invoice_create, methods=['POST'])
    ...
    invoice_routes.add_url_rule('/update-status/<invoice_code>', view_func=c.update_status, methods=['GET'])
