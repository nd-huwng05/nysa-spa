...
Revision ID: 0b71cd92f9ba
Revises: d748eb1f3c4d
Create Date: 2025-12-18 21:54:08.803229
...
revision = '0b71cd92f9ba'
down_revision = 'd748eb1f3c4d'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('invoice', schema=None) as batch_op:
        batch_op.add_column(sa.Column('payment_type', sa.Enum('FULL', 'DISPOSIT', name='paymenttype'), server_default='FULL', nullable=False))
        batch_op.alter_column('create_at',
               existing_type=mysql.DATETIME(),
               server_default=sa.text('now()'),
               existing_nullable=True)
