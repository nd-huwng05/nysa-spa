...
Revision ID: 247f548fe4d8
Revises: 46aad5594823
Create Date: 2025-12-19 00:53:59.283393
...
revision = '247f548fe4d8'
down_revision = '46aad5594823'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('invoice', schema=None) as batch_op:
        batch_op.alter_column('payment_type',
               existing_type=mysql.ENUM('FULL', 'DISPOSIT'),
               type_=sa.Enum('FULL', 'DEPOSIT', name='paymenttype'),
               existing_nullable=False,
...
def downgrade():
    ...
    with op.batch_alter_table('invoice', schema=None) as batch_op:
        ...
        batch_op.alter_column('create_at',
               ...
               existing_nullable=True)
        batch_op.alter_column('payment_type',
               existing_type=sa.Enum('FULL', 'DEPOSIT', name='paymenttype'),
               type_=mysql.ENUM('FULL', 'DISPOSIT'),
               existing_nullable=False,
               existing_server_default=sa.text("'FULL'"))
