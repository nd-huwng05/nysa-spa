...
Revision ID: c31e77428f8f
Revises: fadf8166e2ca
Create Date: 2025-12-19 20:35:22.149423
...
revision = 'c31e77428f8f'
down_revision = 'fadf8166e2ca'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('invoice', schema=None) as batch_op:
        ...
        batch_op.alter_column('payment_type',
               existing_type=mysql.ENUM('FULL', 'DEPOSIT'),
               server_default=None,
               nullable=True)
        batch_op.alter_column('create_at',
               existing_type=mysql.DATETIME(),
