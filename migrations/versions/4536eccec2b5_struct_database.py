...
Revision ID: 4536eccec2b5
Revises: dfacefa9ba6a
Create Date: 2025-12-15 16:47:43.148423
...
revision = '4536eccec2b5'
down_revision = 'dfacefa9ba6a'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('booking_detail', schema=None) as batch_op:
        batch_op.add_column(sa.Column('status', sa.Enum('PENDING', 'PAYING', 'PAID', 'PROCESSING', 'COMPLETED', 'CANCELED', name='bookingstatus'), nullable=False))
